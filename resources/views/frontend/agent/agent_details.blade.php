                ...
                <div class="agency-details-content">
                    <div class="agents-block-one">
                        <div class="inner-box mr-0">
                            <figure class="image-box"><img src="{{ (!empty($agent->photo)) ? url('upload/agent_images/'.$agent->photo) : url('upload/no_image.jpg') }}" style="width:270px; height:330px;"alt=""></figure>
                            <div class="content-box">
                                ...
                                <ul class="info clearfix mr-0">
                                    <li><i class="fab fa fa-envelope"></i><a href="mailto:info@realhome.com">{{ $agent->email }}</a></li>
                                    ...
                                    <div class="wrapper list">
                                        <div class="deals-list-content list-item">
                                            ...
                                            <div class="deals-block-one">
                                                <div class="inner-box">
                                                    <div class="image-box">
                                                        <figure class="image"><img src="{{ asset($item->property_thambnail) }}" alt="" style="height: 300px; width: 350px;"></figure>
