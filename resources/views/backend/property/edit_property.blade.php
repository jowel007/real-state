    ...
    <div class="row">
     ...
     <select name="amenities_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%">
            ...
            @foreach($amenities as $ameni)
                <option value="{{ $ameni->amenities_name }}" {{ (in_array($ameni->amenities_name,$property_ami)) ? 'selected' : '' }}>{{ $ameni->amenitis_name }}</option>
            @endforeach
...
<!--    /// End  Property Facilities Update //// -->




            <!--========== Start of add multiple Facilities with ajax ==============-->
            <div style="visibility: hidden">
             ...
             <!--========== End of add multiple Facilities with ajax ==============-->
