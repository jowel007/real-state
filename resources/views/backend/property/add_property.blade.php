...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <a href="https://www.latlong.net/convert-address-to-lat-long.html" target="_blank">Go Here To Latitude</a>
            </div>
        </div><!-- Col -->
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <a href="https://www.latlong.net/convert-address-to-lat-long.html" target="_blank">Go Here To Longitude</a>
            </div>
        </div><!-- Col -->
    </div><!-- Row -->
            ...
            <div class="mb-3">
                ...
                <select name="ptype_id" class="form-select" id="exampleFormControlSelect1">
                    ...
                    @foreach ($propertytype as $type)
                        <option value="rent">{{ $type->type_name }}</option>
                    @endforeach
                </select>
            </div>
        </div><!-- Col -->
    ...
    <div class="row add_item">
      ...
      <button type="button" class="btn btn-primary submit">Save Property</button>
    </div>
</div>
